...
type AmrCustomerHandler struct {
	service *services.AmrCustomerService
	logr    *zap.Logger
}

func NewAmrCustomerHandler(svc *services.AmrCustomerService, logr *zap.Logger) *AmrCustomerHandler {
	return &AmrCustomerHandler{service: svc, logr: logr}
}
...
func buildAmrFilterParams(r *http.Request, dateFrom, dateTo time.Time) models.AmrReadingFilterParams {
	q := r.URL.Query()
	return models.AmrReadingFilterParams{
		DateFrom:       dateFrom,
		DateTo:         dateTo,
...
func (h *AmrCustomerHandler) GetDailyConsumption(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (h *AmrCustomerHandler) GetAggregatedConsumption(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	q := r.URL.Query()
...
func (h *AmrCustomerHandler) GetMeterStatus(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (h *AmrCustomerHandler) GetMeterStatusSummary(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (h *AmrCustomerHandler) GetMeterStatusTimeline(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (h *AmrCustomerHandler) GetMeterStatusDetails(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	q := r.URL.Query()
	...
	params := models.AmrStatusDetailQueryParams{
...
func (h *AmrCustomerHandler) GetMeterHealthSummary(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (h *AmrCustomerHandler) GetMeterHealthDetails(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	q := r.URL.Query()
	...
	params := models.AmrHealthDetailParams{
		AmrReadingFilterParams: buildAmrFilterParams(r, dateFrom, dateTo),
		Page:                   page,
		Limit:                  limit,
		Search:                 q.Get("search"),
...
func (h *AmrCustomerHandler) GetRegions(w http.ResponseWriter, r *http.Request) {
	regions, err := h.service.GetUniqueRegions(r.Context())
	if err != nil {
		h.logr.Error("amr: failed to get regions", zap.Error(err))
		writeJSON(w, http.StatusInternalServerError, map[string]string{"error": "failed to retrieve regions"})
		return
	}
	writeJSON(w, http.StatusOK, map[string]interface{}{
		"data":  regions,
...
func (h *AmrCustomerHandler) GetDistricts(w http.ResponseWriter, r *http.Request) {
	region := r.URL.Query().Get("region")
	districts, err := h.service.GetUniqueDistricts(r.Context(), region)
	if err != nil {
		h.logr.Error("amr: failed to get districts", zap.Error(err))
		writeJSON(w, http.StatusInternalServerError, map[string]string{"error": "failed to retrieve districts"})
		return
	}
	writeJSON(w, http.StatusOK, map[string]interface{}{
		"data":  districts,
...
func (h *AmrCustomerHandler) GetCommunities(w http.ResponseWriter, r *http.Request) {
	q := r.URL.Query()
	...
	if err != nil {
		...
		writeJSON(w, http.StatusInternalServerError, map[string]string{"error": "failed to retrieve communities"})
		return
	}
	writeJSON(w, http.StatusOK, map[string]interface{}{
		"data":  communities,
...
func (h *AmrCustomerHandler) GetTariffClasses(w http.ResponseWriter, r *http.Request) {
	tariffs, err := h.service.GetUniqueTariffClasses(r.Context())
	if err != nil {
		h.logr.Error("amr: failed to get tariff classes", zap.Error(err))
		writeJSON(w, http.StatusInternalServerError, map[string]string{"error": "failed to retrieve tariff classes"})
		return
	}
	writeJSON(w, http.StatusOK, map[string]interface{}{
		"data":  tariffs,
...
func (h *AmrCustomerHandler) GetContractStatuses(w http.ResponseWriter, r *http.Request) {
	statuses, err := h.service.GetUniqueContractStatuses(r.Context())
	if err != nil {
		h.logr.Error("amr: failed to get contract statuses", zap.Error(err))
		writeJSON(w, http.StatusInternalServerError, map[string]string{"error": "failed to retrieve contract statuses"})
		return
	}
	writeJSON(w, http.StatusOK, map[string]interface{}{
		"data":  statuses,
...
func (h *AmrCustomerHandler) GetCustomerTypes(w http.ResponseWriter, r *http.Request) {
	types, err := h.service.GetUniqueCustomerTypes(r.Context())
	if err != nil {
		h.logr.Error("amr: failed to get customer types", zap.Error(err))
		writeJSON(w, http.StatusInternalServerError, map[string]string{"error": "failed to retrieve customer types"})
		return
	}
	writeJSON(w, http.StatusOK, map[string]interface{}{
		"data":  types,
...
func (h *AmrCustomerHandler) GetServiceTypes(w http.ResponseWriter, r *http.Request) {
	types, err := h.service.GetUniqueServiceTypes(r.Context())
	if err != nil {
		h.logr.Error("amr: failed to get service types", zap.Error(err))
		writeJSON(w, http.StatusInternalServerError, map[string]string{"error": "failed to retrieve service types"})
		return
	}
	writeJSON(w, http.StatusOK, map[string]interface{}{
		"data":  types,
...
func (h *AmrCustomerHandler) GetMeterByNumber(w http.ResponseWriter, r *http.Request) {
	...
	var records []models.AmrCustomerRecord
