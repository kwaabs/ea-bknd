...
type CustomerSalesZeusFilterParams struct {
	RegionName          []string
	DistrictName        []string
	ServiceType         []string
	ServiceClass        []string
...
type CustomerSalesZeusDetailResult struct {
	Data       []CustomerSalesZeus `json:"data"`
	Total      int                 `json:"total"`
	Page       int                 `json:"page"`
	Limit      int                 `json:"limit"`
	TotalPages int                 `json:"total_pages"`
...
type CustomerSalesZeusAggregateRow struct {
	DataSrc string `bun:"data_src" json:"data_src"`
...
type CustomerSalesZeusAggregateResult struct {
	Data   []CustomerSalesZeusAggregateRow `json:"data"`
	Total  int                             `json:"total"`
}
