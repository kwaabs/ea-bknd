...
// MMSCustomerSales mirrors a row from app.mms_customer_sales (STS/prepaid sales).
type MMSCustomerSales struct {
...
// MMSCustomerSalesFilterParams holds filters for detail/aggregate queries.
type MMSCustomerSalesFilterParams struct {
	Region        []string
	District      []string
	ContractType  []string
	Tariff        []string
...
// MMSCustomerSalesDetailResult is the paginated detail response.
type MMSCustomerSalesDetailResult struct {
	Data       []MMSCustomerSales `json:"data"`
...
// MMSCustomerSalesAggregateRow is a single grouped aggregate row.
type MMSCustomerSalesAggregateRow struct {
	DataSrc                   string  `bun:"data_src" json:"data_src"`
...
// MMSCustomerSalesAggregateResult is the aggregate response.
type MMSCustomerSalesAggregateResult struct {
	Data  []MMSCustomerSalesAggregateRow `json:"data"`
	Total int                            `json:"total"`
}
