...
type AmrCustomerService struct {
	db *bun.DB
}

func NewAmrCustomerService(db *bun.DB) *AmrCustomerService {
	return &AmrCustomerService{db: db}
}
...
func buildAmrFilters(params models.AmrReadingFilterParams) []AmrFilter {
...
func (s *AmrCustomerService) GetDailyConsumption(
	ctx context.Context,
	params models.AmrReadingFilterParams,
) ([]models.AmrDailyConsumptionResult, error) {
	var results []models.AmrDailyConsumptionResult
	...
	q = q.
		...
		OrderExpr("mcd.consumption_date, mcd.meter_number")
...
func (s *AmrCustomerService) GetAggregatedConsumption(
	ctx context.Context,
	params models.AmrReadingFilterParams,
	groupBy string,
	additionalGroups []string,
) ([]models.AmrAggregatedConsumptionResult, error) {
	var results []models.AmrAggregatedConsumptionResult
...
func (s *AmrCustomerService) GetMeterStatus(
	ctx context.Context,
	params models.AmrReadingFilterParams,
) ([]models.AmrMeterStatusResult, error) {
	var results []models.AmrMeterStatusResult
...
func (s *AmrCustomerService) GetMeterStatusSummary(
	ctx context.Context,
	params models.AmrReadingFilterParams,
) (*models.AmrMeterStatusSummary, error) {
	...
	return &models.AmrMeterStatusSummary{
		Total:               total,
		Online:              row.Online,
...
func (s *AmrCustomerService) GetMeterStatusTimeline(
	ctx context.Context,
	params models.AmrReadingFilterParams,
) (*models.AmrMeterStatusTimeline, error) {
	...
	var entries []models.AmrMeterStatusTimelineEntry
	...
	timeline := &models.AmrMeterStatusTimeline{Data: entries}
...
func (s *AmrCustomerService) GetMeterStatusDetails(
	ctx context.Context,
	params models.AmrStatusDetailQueryParams,
) (*models.AmrMeterStatusDetailResponse, error) {
	...
	var records []models.AmrMeterStatusDetailRecord
	...
	resp := &models.AmrMeterStatusDetailResponse{
		Data:           records,
		FiltersApplied: filtersApplied,
	}
...
func (s *AmrCustomerService) GetMeterHealthSummary(
	ctx context.Context,
	params models.AmrReadingFilterParams,
) (*models.AmrMeterHealthSummary, error) {
	...
	// --- By Tariff Class ---
	var byTariff []models.AmrHealthByTariffClass
	...
	// --- By Region ---
	var byRegion []models.AmrHealthByRegion
	...
	return &models.AmrMeterHealthSummary{
		...
		UptimeDistribution: models.AmrMeterUptimeDistribution{
...
func (s *AmrCustomerService) GetMeterHealthDetails(
	ctx context.Context,
	params models.AmrHealthDetailParams,
) (*models.AmrMeterHealthDetailResponse, error) {
	...
	var records []models.AmrMeterHealthDetailRecord
	if err := q.Scan(ctx, &records); err != nil {
		return nil, err
	}
	...
	resp := &models.AmrMeterHealthDetailResponse{
		Data:           records,
		FiltersApplied: filtersApplied,
	}
	resp.Pagination.Page = params.Page
...
func (s *AmrCustomerService) GetUniqueRegions(ctx context.Context) ([]string, error) {
	var regions []string
	err := s.db.NewSelect().
...
func (s *AmrCustomerService) GetUniqueDistricts(ctx context.Context, region string) ([]string, error) {
...
func (s *AmrCustomerService) GetUniqueCommunities(ctx context.Context, region, district string) ([]string, error) {
...
func (s *AmrCustomerService) GetUniqueTariffClasses(ctx context.Context) ([]string, error) {
	var tariffs []string
	err := s.db.NewSelect().
		TableExpr("app.amr_customer_records").
...
func (s *AmrCustomerService) GetUniqueContractStatuses(ctx context.Context) ([]string, error) {
	var statuses []string
	err := s.db.NewSelect().
		TableExpr("app.amr_customer_records").
...
func (s *AmrCustomerService) GetUniqueCustomerTypes(ctx context.Context) ([]string, error) {
	var types []string
	err := s.db.NewSelect().
		TableExpr("app.amr_customer_records").
...
func (s *AmrCustomerService) GetUniqueServiceTypes(ctx context.Context) ([]string, error) {
	var types []string
	err := s.db.NewSelect().
		TableExpr("app.amr_customer_records").
...
func (s *AmrCustomerService) DB() *bun.DB {
	return s.db
}
